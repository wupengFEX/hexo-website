...
- **开发者**
    ...
    - 定义script配置标签，并配置以下信息：
        ...
        - authorization：授权接口，返回example-access表达式中需要进行计算的数据；
        ...
        - authorizationFallbackResponse：如果授权接口请求失败，需要在这里配置相关接口参数作为backup；
            ...
            ```
        - authorizationTimeout：授权接口请求超时时间，默认为3s；
...
- 整体时序图（如果是付费页面，通过后端数据标示，必须做到登录强相关） 
...
- 流程图 
    ...
    <img src="http://upload-images.jianshu.io/upload_images/2483150-8f23bde37364b354.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240" width = "600" align=center />

- ID系统（ID不会重复，ID是针对某个站点整站来说的）

    <img src="http://upload-images.jianshu.io/upload_images/2483150-f36c6456fec5e97f.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240" width = "600" align=center />

- 计量系统

    <img src="http://upload-images.jianshu.io/upload_images/2483150-09ef1ec239419813.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240" width = "600" align=center />
